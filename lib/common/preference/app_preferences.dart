...
class AppPreferences {
  ...
  // SharedPreferences에 값을 설정하는 함수
  static bool checkIsNullable<T>() => null is T;

  // 주어진 키(item.key)에 대한 값(value)을 SharedPreferences에 저장하는 함수입니다.
  //isNullable 함수를 사용하여 타입이 nullable인지 확인하고, nullable인 경우 null을 저장하면 해당 키를 제거하는 방식으로 동작합니다.
